(function(f) {
    ...
    return function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            "./src/dracula": 221,
            "./src/layout/ordered_tree": 223,
            "./src/layout/spring": 224,
            "./src/layout/tournament_tree": 225,
            "./src/renderer/raphael": 226
        }],
            ...
            var Spring = function(_Layout) {
                ...
                _createClass(Spring, [{
                    ...
                    value: function layoutAttractive(edge) {
                        ...
                        attractiveForce *= Math.log(edge.attraction) * .5 + 1;
        ...
        226: [function(require, module, exports) {
            ...
            var dragify = function dragify(shape) {
                ...
                shape.items.forEach(function(item) {
					var opacity = item.attrs["fill-opacity"] || 0.2;
                    item.set = shape;
                    if (item.type === "text") {
                        return
                    }
                    ...
                    value: function drawNode(node) {
                        ...
                        if (node.render) {
                            ...
                            node.shape.push(this.canvas.ellipse(0, 0, 30, 20).attr({
                                ...
                                fill: color,
                                "fill-opacity": 0.2
                            })).push(this.canvas.text(0, 30, node.label || node.id)).translate(node.point[0], node.point[1])
                        }
